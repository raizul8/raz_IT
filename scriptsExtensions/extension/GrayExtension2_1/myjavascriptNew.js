...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    "^": "",
    makeAllGray: function() {
      var $async$goto = 0, $async$completer = P.Completer_Completer$sync(), $async$returnValue, siteUrl, t1, spanRed, t2, t3, allP, i, ytd_watch, span_plc, _i, preList, td;
      var $async$makeAllGray = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              if (J.getInterceptor$asx(siteUrl).contains$1(siteUrl, "kobatochan.com")) {
                t1 = document;
                spanRed = t1.getElementsByClassName("animated-candystripe");
                t2 = spanRed.length;
                if (t2 !== 0) {
                  if (0 >= t2) {
                    $async$returnValue = H.ioore(spanRed, 0);
                    // goto return
                    $async$goto = 1;
                    break;
                  }
                ...
                allP = t1.getElementsByTagName("p");
                for (i = 0; i < allP.length; ++i) {
                  t1 = J.get$style$x(allP[i]);
                  t1.color = "rgb(200,200,200)";
                }
                // goto return
                $async$goto = 1;
                break;
              }
              $async$goto = C.JSString_methods.contains$1(siteUrl, "https://www.youtube.com") ? 3 : 4;
              break;
            case 3:
              // then
              $async$goto = 5;
              return P._asyncAwait(P.Future_Future$delayed($.pauseDuration, null, null), $async$makeAllGray);
            case 5:
              // returning from await.
              t1 = document;
              t2 = t1.querySelector("#container").style;
              t2.backgroundColor = "rgb(70,70,70)";
              ytd_watch = t1.getElementsByTagName("ytd-watch");
              if (0 >= ytd_watch.length) {
                $async$returnValue = H.ioore(ytd_watch, 0);
                // goto return
                $async$goto = 1;
                break;
              }
              t1 = J.get$style$x(ytd_watch[0]);
              t1.backgroundColor = "rgb(70,70,70)";
              // goto return
              $async$goto = 1;
              break;
            case 4:
              // join
              $async$goto = C.JSString_methods.contains$1(siteUrl, "https://github.com") ? 6 : 7;
              break;
            case 6:
              // then
              $async$goto = 8;
              return P._asyncAwait(P.Future_Future$delayed(C.Duration_2000000, null, null), $async$makeAllGray);
            case 8:
              // returning from await.
              t1 = document;
              span_plc = t1.getElementsByClassName("pl-c");
              for (t2 = span_plc.length, _i = 0; _i < span_plc.length; span_plc.length === t2 || (0, H.throwConcurrentModificationError)(span_plc), ++_i) {
                t3 = J.get$style$x(span_plc[_i]);
                t3.color = "#3a8a3a";
              }
              preList = t1.getElementsByTagName("pre");
              for (t1 = preList.length, _i = 0; _i < preList.length; preList.length === t1 || (0, H.throwConcurrentModificationError)(preList), ++_i) {
                t2 = J.get$style$x(preList[_i]);
                t2.backgroundColor = "rgb(190,190,190)";
              }
              F.allDark();
              // goto return
              $async$goto = 1;
            ...
            case 7:
              // join
              if (C.JSString_methods.contains$1(siteUrl, "gobyexample.com")) {
                td = document.getElementsByTagName("td");
                for (t1 = td.length, _i = 0; _i < td.length; td.length === t1 || (0, H.throwConcurrentModificationError)(td), ++_i) {
                  t2 = J.get$style$x(td[_i]);
                  t3 = $.lightGray;
              ...
              C.JSArray_methods.forEach$1($.$get$sites(), new F.makeAllGray_closure(siteUrl));
            case 1:
              // return
              return P._asyncReturn($async$returnValue, $async$completer);
          }
      });
      return P._asyncStart($async$makeAllGray, $async$completer);
    },
    allDark: function() {
      var t1, t2, t3, t4, divs, _i, div, allP, i, allT, articles, sect, spanList, preList;
      t1 = document;
      t2 = t1.body.style;
      t3 = $.lightGray;
      t2.backgroundColor = t3;
      ...
      t4 = $.black;
      t2.color = t4;
      t2 = t1.documentElement.style;
      t2.backgroundColor = t3;
      t2 = t1.querySelector("html").style;
      t3 = $.lightGray;
      t2.backgroundColor = t3;
      divs = t1.getElementsByTagName("div");
      for (t2 = divs.length, _i = 0; _i < divs.length; divs.length === t2 || (0, H.throwConcurrentModificationError)(divs), ++_i) {
        div = divs[_i];
        t3 = J.get$style$x(div);
        t4 = $.lightGray;
      ...
      allP = t1.getElementsByTagName("p");
      for (i = 0; i < allP.length; ++i) {
        t2 = J.get$style$x(allP[i]);
        t2.color = "black";
      }
      allT = t1.getElementsByTagName("table");
      for (i = 0; i < allT.length; ++i) {
        t2 = J.get$style$x(allT[i]);
        t3 = $.lightGray;
        t2.backgroundColor = t3;
      }
      articles = t1.getElementsByTagName("article");
      for (i = 0; i < articles.length; ++i) {
        t2 = J.get$style$x(articles[i]);
        t3 = $.lightGray;
        t2.backgroundColor = t3;
      }
      sect = t1.getElementsByTagName("section");
      for (i = 0; i < sect.length; ++i) {
        t2 = J.get$style$x(sect[i]);
        t3 = $.lightGray;
        t2.backgroundColor = t3;
        if (i >= sect.length)
          return H.ioore(sect, i);
        t2 = J.get$style$x(sect[i]);
        t2.color = "black";
      }
      spanList = t1.getElementsByTagName("span");
      for (i = 0; i < spanList.length; ++i) {
        t2 = J.get$style$x(spanList[i]);
        t2.color = "black";
      }
      preList = t1.getElementsByTagName("pre");
      for (i = 0; i < preList.length; ++i) {
        t1 = J.get$style$x(preList[i]);
        t2 = $.lightGray;
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              ...
              $async$goto = 2;
              return P._asyncAwait(F.makeAllGray(), $async$main);
            case 2:
              // returning from await.
              // implicit return
    ...
    }, "call$0", "main__main$closure", 0, 0, 12],
    makeAllGray_closure: {
      "^": "Closure:4;siteUrl",
      call$1: function(site) {
        if (J.contains$1$asx(this.siteUrl, site))
          return;
      }
    }
  }, 1]];
...
;
  ...
  $.Expando__keyCount = 0;
  $.divOutput = null;
  $.pauseDuration = C.Duration_3500000;
  ...
  (function(lazies) {
    ...
    return [];
  }, "_toStringVisiting", "sites", "$get$sites", function() {
    return ["myline-eon.ro", "mangafox", "mangareader", "play.google.com", "127.0.0.1", "twitter.com", "moqups", "imdb", "localhost", "http://css3please.com/", "www.pinterest.com", "github.com/raizul8", "www.youtube.com", "http://www.pornhub.com/", "://codepen.io/", "https://docs.google.com", "http://codepen.io/", "http://192.168.1.1/", "drive.google.com", "flipboard.com", "dartpad.dartlang.org", "http://www.gorillatoolkit.org/", "http://hentaihaven.org/", "lnmtl", "http://code.runnable.com/", "www.draw.io"];
  }, "sites"]);
  Isolate = Isolate.$finishIsolateConstructor(Isolate);
  $ = new Isolate();
  init.metadata = [];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [P.String]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [, P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.int,,]}, {func: 1, args: [,], opt: [,]}, {func: 1, args: [,,]}, {func: 1, ret: P.Future}];
...
//# sourceMappingURL=myjavascriptNew.js.map
